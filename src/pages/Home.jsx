      ...
      <section className="hero" aria-label="Introduction" data-reveal>
        <div className="hero-media" aria-hidden="false">
          <picture>
            ...
            <img
              src="/Hero page banners/Hero banner - Desktop.jpg"
              alt="A couple sharing a warm moment at a celebration held at Antra Luxe"
              width="1600"
              height="690"
              fetchPriority="high"
            />
        ...
        <div className="wrap hero-inner">
          <div className="hero-copy">
            ...
            <div className="hero-cta">
              ...
              <Link className="btn btn--secondary" to="/spaces">Explore our spaces</Link>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="hero-stats" aria-label="Venue at a glance">
        <div className="wrap">
          <div className="stat" data-reveal-item>
            <b>1,500</b>
            <span>Seated in the main hall</span>
          </div>
          <div className="stat" data-reveal-item>
            <b>5</b>
            <span>Distinct spaces</span>
          </div>
          <div className="stat" data-reveal-item>
            <b>60</b>
            <span>Rooms on site</span>
          </div>
          <div className="stat" data-reveal-item>
            <b>300</b>
            <span>Car parking spaces</span>
          </div>
        </div>
      </section>
        ...
        <div className="wrap">
          ...
          <div className="stories-grid">
            <div className="quote-block">
              ...
              <cite>{quotes[0].cite}</cite>
              <div className="quote-nav">
                <button type="button" aria-label="Previous testimonial" disabled>
                  <svg className="icon" viewBox="0 0 24 24" aria-hidden="true"><path d="M19 12H5"/><path d="m11 18-6-6 6-6"/></svg>
                </button>
                <button type="button" aria-label="Next testimonial" disabled>
            ...
            <div className="gallery-preview">
              ...
              <a href="#gallery" aria-label="View the full gallery">View full gallery</a>
            </div>
          </div>
        </div>
      </section>
